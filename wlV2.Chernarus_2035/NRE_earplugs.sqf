...
if (isNil "NreEarplugsActive") then {
	NreEarplugsActive = 0;
	1 fadeSound 1;
	_id = player addAction [("<t color=""#00FF00""><img size='2' image='\a3\ui_f\data\IGUI\Cfg\Actions\arrow_down_gs'/>" + (localize "STR_NREEP_IN_ACTION") +"</t>"),NreEarplugsPath+"NRE_earplugs.sqf","",5,false,true,"",""];
	...
	player addEventHandler ["Respawn", {
		...
		_id = (_this select 0) addAction [("<t color=""#00FF00""><img size='2' image='\a3\ui_f\data\IGUI\Cfg\Actions\arrow_down_gs'/>" + (localize "STR_NREEP_IN_ACTION") +"</t>"),NreEarplugsPath+"NRE_earplugs.sqf","",5,false,true,"",""];
...
if ( NreEarplugsActive == 1 ) then {
	...
	_id = player getVariable "NreEarplugsAction";
	player removeAction _id;
	_id = player addAction [("<t color=""#FF0000""><img size='2' image='\a3\ui_f\data\IGUI\Cfg\Actions\arrow_up_gs'/>" + (localize "STR_NREEP_OUT_ACTION") +"</t>"),NreEarplugsPath+"NRE_earplugs.sqf","",5,false,true,"",""];
	player setVariable ["NreEarplugsAction", _id];
};
